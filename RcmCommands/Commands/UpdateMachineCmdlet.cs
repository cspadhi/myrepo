//---------------------------------------------------------------
//  <copyright file="UpdateMachineCmdlet.cs" company="Microsoft">
//      Copyright (c) Microsoft Corporation. All rights reserved.
//  </copyright>
//
//  <summary>
//  Defines class for Update-Machine cmdlet.
//  </summary>
//
...
namespace RcmCommands
{
    ...
    /// Modify machine.
    /// </summary>
    [Cmdlet(VerbsData.Update, "Machine", DefaultParameterSetName = RcmParameterSets.Default)]
    public class UpdateMachineCmdlet : RcmCmdletBase
    {
        #region Parameters
        ...
        public override void ExecuteRcmCmdlet()
        {
            ...
            if (registerMachineInput != null)
            {
                ...
                this.ModifyMachine(registerMachineInput);
            }
        }
        ...
        /// <summary>
        /// Makes ModifyMachine call.
        /// </summary>
        /// <param name="registerMachineInput">RegisterMachineInput object.</param>
        private void ModifyMachine(RegisterMachineInput registerMachineInput)
        {
            RcmClientForAgent.ModifyMachine(
                registerMachineInput,
                PSRcmClient.GetAgentOperationContext(this.Id));
            this.WriteObject("Machine data updated in RCM.");
        }
    }
}
